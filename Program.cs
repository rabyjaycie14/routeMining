    ...
    internal class Program
    {
        ...
        public class add_API_Name : Decorator
        {
            ...
            public override string Handle(string request)
            {
                if (request as string == "ss")
                {
                    return " returned by SmartyStreets API";
                }
                else if (request as string == "ups")
                {
                    return " returned by UPS Street Level API";
                }
        ...
        private static void Main(string[] args)
        {
            ...
            API_abstractHandler ups = new API_ups();
            API_abstractHandler ss = new API_smartyStreets();
            ...
            ClientRequest.ClientInput(ss, "ss");
            Console.WriteLine();
            ...
            ups = new add_API_Name(ups); // add decorator
            string result = ClientRequest.ClientInput(ups, "ups"); //make request with decorator
